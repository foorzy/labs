...
<body>
<?php require_once 'processproductdetails.php'; ?>
    ...
    <div class="collapse" id="navbarToggleExternalContent">
		...
		<div class="light p-3" style="background-color: #e3f2fd;">
			<ul class="nav nav-pills nav-fill">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="productdetails.php#">Инфо о продуктах</a>
                </li>
				<li class="nav-item">
...
<div class="container">
    ...
    $result = $mysqli->query("SELECT productdetails.ID, products.Name, productdetails.Color, productdetails.Description FROM productdetails,products WHERE productdetails.ID=products.ID ORDER BY ID ASC") or die($mysqli->error);
    ?>
        ...
        <table class="table">
            ...
            while ($row = $result->fetch_assoc()): ?>
                <tr>
					...
					?>
                    <td>
                        <a href="productdetails.php?edit=<?php echo $row['ID']; ?>"
                           class="btn btn-info">Изменить</a>
                        <a href="processproductdetails.php?delete=<?php echo $row['ID']; ?>"
            ...
            <?php endwhile; ?>
					...
					?>
    <div class="row justify-content-center">
        <form action="processproductdetails.php" method="POST">
            ...
            <div class="form-group">
                <label>Цвет</label>
                <input type="text" name="Color" class="form-control" pattern="[A-Za-zА-Яа-я, ,0-9]{1,}$"
                       value="<?php echo $Color; ?>" placeholder="Введите цвет товара" required>
            </div>
			<div class="form-group">
                <label>Описание</label>
                <input type="text" name="Description" class="form-control" pattern="[A-Za-zА-Яа-я, ,0-9]{1,}$"
                       value="<?php echo $Description; ?>" placeholder="Введите описание" required>
            </div>
            <div class="form-group">
                <?php
                if($update == true):
