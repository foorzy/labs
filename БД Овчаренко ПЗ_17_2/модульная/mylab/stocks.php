...
<div class="container">
    ...
    $result = $mysqli->query("SELECT stocks.ProductID, products.Name, stocks.Qty FROM stocks,products WHERE stocks.ProductID=products.ID ORDER BY ProductID ASC") or die($mysqli->error);
    ?>
