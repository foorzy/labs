...
namespace Shop
{
    public partial class Form1 : Form
    {
        ...
        {
            string connectionString = @"Data Source=DESKTOP-KFHA9I5\SQLEXPRESS;Initial Catalog=InternetShopDB;Integrated Security=True";
        ...
        private async void buttonFilter_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(textBoxFilter.Text) && !string.IsNullOrWhiteSpace(textBoxFilter.Text))
                {
                    ...
                    command.Parameters.AddWithValue("Price", textBoxFilter.Text);
        ...
        private void справкаToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                System.Diagnostics.Process.Start("Documentation2_bondarenko_pz_17_2.docx");
            }
            catch (Exception exp)
            {
